...
The jail does the following things:
* Hide your whole filesystem from the editor except for:
  + Files needed by antigravity and chromium to work.
  + The project dir you start antigravity on (as command line argument)
* Gives access to a subset of defined set of commands within the editor.
